...
**正在使用手机浏览本页面的用户 [请点击这里](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever) ，查看完整的说明文档。**
...
- 增加使用代理组的懒人配置；
- 由于世界排名 top 500 网站列表已无法通过无账户/免费方式取得，故原来的 top500 检测方法失效。我已根据旧的 top500 榜单重构了新的 top500 网站连接情况表。**同时，希望大家可以帮助 pull requests 一份最新的 top500 榜单: [格式](https://github.com/b1ingo/Shadowrocket-ADBlock-Rules-Forever/blob/build/factory/resultant/top500_manual.list)**
- **所有发布的规则都会在每天北京时间 8:00 更新发布**


## 规则列表

![规则选择指南](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/guide.png)
...
任何问题欢迎在 [Issues](https://github.com/b1ingo/Shadowrocket-ADBlock-Rules-Forever/issues) 中反馈。

你的反馈会让此规则变得更加完美。

**如何贡献代码？**

通常的情况下，对 [factory 目录](https://github.com/b1ingo/Shadowrocket-ADBlock-Rules-Forever/tree/build/factory) 下的 3 个 `manual_*.txt` 文件做对应修改即可。**Pull requests 请发送至 build 分支。**
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/sr_top500_banlist_ad.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/sr_top500_banlist_ad.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/sr_top500_whitelist_ad.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/sr_top500_whitelist_ad.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/sr_top500_banlist.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/sr_top500_banlist.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/sr_top500_whitelist.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/sr_top500_whitelist.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/sr_cnip_ad.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/sr_cnip_ad.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/sr_cnip.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/sr_cnip.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/sr_direct_banad.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/sr_direct_banad.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/sr_proxy_banad.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/sr_proxy_banad.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/sr_backcn.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/sr_backcn.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/sr_backcn_ad.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/sr_backcn_ad.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/sr_ad_only.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/sr_ad_only.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/lazy.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/lazy.png)
...
规则地址：<https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/lazy_group.conf>

![二维码](https://b1ingo.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/lazy_group.png)
...
[![Stargazers over time](https://starchart.cc/b1ingo/Shadowrocket-ADBlock-Rules-Forever.svg)](https://starchart.cc/b1ingo/Shadowrocket-ADBlock-Rules-Forever)
